  ...
  return (
    <div>
      ...
      <p className="px-4 md:px-10 text-justify">
        ...
        varied sectors like Restaurants, Auto Care, Home Decor, Personal and Pet
        Care, Fitness, Insurance, Real Estate, Sports, Schools, etc. from all
        over the country. Holding information right from major cities in
        srilanka.
      </p>
    </div>
  );
